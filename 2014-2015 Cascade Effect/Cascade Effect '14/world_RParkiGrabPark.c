...
//starts from right side of parking zone
//brings back to parking zone
task main()
{
...
//DEFENSE
	...
	override diagonalTo()
		...
		coastTo(70);
		rotateCoast(1,-85);
		coastTo(70); //runs back and fourth to mess oponent
		wait1Msec(300);
		coastTo(-50);
		wait1Msec(300);
		coastTo(70);
...
//DEFENSE
		...
		coastTo(40);
		diagonalTo(30, 315);
		diagonalTo(30, 315);//aligns to wall, hopefully
		diagonalTo(13, 40);
		//strafeTo(-8);//aligns to wall
